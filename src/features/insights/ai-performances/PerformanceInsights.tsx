...
export function PerformanceInsights() {
  return (
    ...
    // white inner card.
    <div className="rounded-2xl bg-gradient-to-r from-[#f4d9c4] via-white to-[#cfeef0] p-[1.5px]">
      <div className="rounded-2xl bg-white p-5">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-2">
            <span className="flex size-6 items-center justify-center rounded-full bg-[#BE297B]">
              <MessageSquare className="size-3.5 text-white" />
            </span>
            <h3 className="text-[14px] font-medium text-ink">Worst performing workflow</h3>
          </div>
        ...
        <div className="mt-4 grid grid-cols-[1.6fr_1.4fr_1fr_1.4fr_auto] items-center gap-y-3 text-[12px]">
...
function Row({
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="justify-self-end rounded-full border border-surface-border px-3 py-1 text-[11px] text-ink"
      >
        View workflow
      </button>
    </>
