...
export const TOPIC_STATS: TopicStat[] = [
  {
    title: 'Total tickets',
    value: '46,943',
    trend: { value: '3.4%', direction: 'up', tone: 'positive' },
    supporting: ['47,345 processed', '1,543 pending'],
  },
  { title: 'Excluded tickets', value: '8,004', share: '12%' },
  { title: 'Categorized tickets', value: '35,594', share: '88%' },
  {
    title: 'First contact resolution',
    value: '75%',
    trend: { value: '1.7%', direction: 'up', tone: 'negative' },
  },
  {
    title: 'Avg. first resolution time',
    value: '24 hrs',
    trend: { value: '3.4%', direction: 'down', tone: 'positive' },
  },
  {
    title: 'Avg. full resolution time',
    value: '29.9 hrs',
    trend: { value: '2.3%', direction: 'down', tone: 'positive' },
  },
  {
    title: 'Sentiment',
    value: '50%',
    sentiment: true,
    trend: { value: '1.7%', direction: 'down', tone: 'negative' },
  },
  {
    title: 'Agent reply time',
    value: '11.7 hrs',
    trend: { value: '12%', direction: 'up', tone: 'negative' },
  },
]
...
// The treemap in the updated Figma exploration uses a broader topic taxonomy
// than the grouped table. Billing's visible 3,586 volume anchors a shared mock total, keeping every
// category's volume proportional to its displayed percentage.
const TREEMAP_TOTAL_VOLUME = 9363

function treemapTopic(
  id: string,
  name: string,
  ticketsPct: string,
  firstContactResolution: string,
  ...
  return {
    ...
    name,
    count: 1,
    tickets: Math.round((TREEMAP_TOTAL_VOLUME * Number.parseFloat(ticketsPct)) / 100),
    ticketsPct,
    ...
    agentReplies: '1.12',
    csat: '4.1',
    children: genericChildren(id),
  }
}

export const TREEMAP_TOPICS: TopicRow[] = [
  treemapTopic('billing', 'Billing', '38.3%', '75.6%', 42.7, '#cf6267'),
  treemapTopic('profile-map', 'Profile management', '13.0%', '71.5%', 50, '#d98b6d'),
  treemapTopic('returns', 'Returns and refunds', '9.6%', '69.4%', 48.6, '#6f89cb'),
  treemapTopic('account-map', 'Account management', '8.1%', '69.4%', 48.6, '#a48abe'),
  treemapTopic('validation', 'Validation and security', '2.8%', '87.3%', 54.7, '#c98287'),
  treemapTopic('contract-map', 'Contract and Job management', '6.2%', '73.4%', 90.4, '#dd8e70'),
  treemapTopic('legal-map', 'Legal and compliance', '2.9%', '84.4%', 60.4, '#9d7db2'),
  treemapTopic('product', 'Product information', '4.5%', '75.6%', 50, '#e9bf54'),
  treemapTopic('payment-map', 'Payment processing', '1.5%', '71.5%', 75.1, '#d6a447'),
  treemapTopic('integrations', 'Integrations and API', '2.7%', '75.6%', 50, '#9f83b5'),
  treemapTopic('shipping', 'Shipping and delivery', '4.8%', '75.6%', 50, '#70afa2'),
  treemapTopic('privacy', 'Data privacy', '5.6%', '75.6%', 50, '#8fa5c0'),
]
