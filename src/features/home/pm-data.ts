...
export const PM_DATA: PmData = {
  ...
  spotlight: {
    trending: [
      ...
      { id: 't3', rank: 3, title: 'SCIM auto-provisioning for user lifecycle', meta: '164 conversations · revenue at risk $455K', stage: 'detected', trendPct: '80%', trendGood: false, up: true, oppId: 'o2' },
    ],
    atRisk: [
      ...
      { id: 'r3', rank: 3, title: 'SCIM auto-provisioning for user lifecycle', meta: '75 customers · Impact 78', tag: 'gap', amount: '$455K', oppId: 'o2' },
    ],
    asking: [
      { id: 'a1', rank: 1, title: 'Salesforce two-way contact sync', meta: 'Deal · Helix Pharma ($96K) · Impact 68', stage: 'planned', amount: '$610K' },
      { id: 'a3', rank: 2, title: 'Dark mode', meta: 'Deal · Free users (free) · Impact 27', stage: 'detected', amount: '$75K' },
    ],
  },
  lifecycle: [
