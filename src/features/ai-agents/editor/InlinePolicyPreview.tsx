...
import { EDITOR_COLUMN_W } from './editor-data'
...
export function InlinePolicyPreview() {
  ...
  return (
    // Unlike the policy editor, the preview's banner spans the content area
    // rather than the document column (Figma 1886:76793) — it is chrome for the
    // review, not part of the document. The rewritten policy below it sits in the
    // same centred column as the editor's.
    <div data-testid="inline-policy-preview" className="flex flex-1 flex-col">
      {/* Header card: title + change counter + bulk actions */}
      <Card className="mb-6 rounded-xl px-6 py-5">
