...
export const AI_STUDIO_PLAN = {
  ...
  // The plan card names the intent in prose casing (Figma 1886:76118); the full
  // view's document heading is title case (`agentName`, frame 1886:76257).
  planSubtitle: 'Service cancellation',
