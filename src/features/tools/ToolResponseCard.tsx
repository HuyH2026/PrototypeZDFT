    ...
    <Card className="grid grid-cols-2 gap-6 p-5">
      <div>
        ...
        <p className="mt-4 text-center text-[12px] text-blue-700">
          Select an array [] to generate a Dynamic list of CV&apos;s or select an individual entity
          for a single CV. Utilize &apos;Advanced Filter&apos; with JMESPath for precise filtering.
        </p>
