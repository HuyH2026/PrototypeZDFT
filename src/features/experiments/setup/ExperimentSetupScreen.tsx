  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 border-b border-surface-border px-6 py-3">
        <button type="button" aria-label="Back to Experiment" onClick={back}>
          <ArrowLeft size={18} className="text-ink" aria-hidden />
        </button>
        <h1 className="text-[15px] font-semibold text-ink">{name || DEFAULT_TEST_NAME}</h1>
        ...
        <div className="flex items-center gap-2">
          <button type="button" className="px-2 py-2 text-[14px] text-ink">
            Preview
          </button>
          <button
            type="button"
            ...
            >
              ...
              <div className="flex items-end gap-4">
                <div className="w-[110px]">
                  ...
                  <div className="mt-1.5 flex items-center justify-between rounded-[20px] border border-grey-400 bg-white px-3.5 py-2 text-[14px] text-ink">
                    <span>100</span>
            ...
            >
              ...
              <div className="flex gap-2">
                {WINNER_METRICS.map((m) => (
                  <span
                    key={m}
                    className="rounded-full border border-[#d2d9e5] bg-grey-100 px-2.5 py-1 text-[12px] text-ink"
                  >
                    {m}
                  </span>
                ))}
                  ...
                  <button
                    ...
                    className={
                      ...
                      (endCondition === 'fixed'
                        ...
                        : 'border-grey-400 text-ink-muted')
                    }
                  >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-1 gap-3">
                  <div className="flex flex-1 items-center gap-2 rounded-[20px] border border-grey-400 bg-white px-3.5 py-2 text-[14px] text-ink">
