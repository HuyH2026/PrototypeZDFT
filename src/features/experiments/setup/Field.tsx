...
const BOX = 'w-full rounded-[20px] border border-grey-400 bg-white px-3.5 py-2 text-[14px] text-ink outline-none placeholder:text-ink-muted'
...
export function SelectField({
  ...
  return (
    <label className="block">
      ...
      <div
        className={`${label ? 'mt-1.5 ' : ''}flex items-center justify-between rounded-[20px] border border-grey-400 bg-white px-3.5 py-2 text-[14px]`}
      >
