...
export const EXPERIMENTS: Experiment[] = [
  {
    ...
    name: 'Test',
    status: 'not-started',
    useCase: 'Log in troubleshooting',
  ...
  },
  {
    ...
    status: 'running',
    useCase: 'Call users with abandoned carts',
    description:
  ...
  },
  {
    ...
    status: 'completed',
    useCase: 'Update shipping address',
  ...
  },
  {
    ...
    status: 'completed',
    useCase: 'Update Billing address',
...
export const WINNER_METRICS = ['Resolutions', 'Sentiment']
...
export const SETUP_VARIANTS: SetupVariant[] = [
  {
    ...
    badge: 'Control',
    badgeColor: '#01567a',
    description: 'The current live Use Case that acts as the baseline.',
    useCase: 'Login troubleshooting',
    traffic: 50,
  },
  {
    key: 'variant-a',
    badge: 'Variant A',
    badgeColor: '#e05c34',
    description: 'The new Use Case you want to test against the control.',
    useCase: 'Auto Reset Password',
    traffic: 50,
  },
]
