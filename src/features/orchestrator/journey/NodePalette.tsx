...
export function NodePalette({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="flex w-[340px] flex-col gap-4 rounded-[21px] border bg-white/80 p-5 shadow-[0px_0px_13px_0px_rgba(0,0,0,0.04)]" style={{ borderColor: 'var(--color-grey-100)' }}>
      ...
      <div className="flex items-center gap-2 rounded-full px-3 py-1.5" style={{ background: 'var(--color-grey-100)' }}>
