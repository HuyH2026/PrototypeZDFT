...
function ConditionChip({ label, tokens }: { label: string; tokens?: string[] }) {
  return (
    <div className="flex-1 rounded-[4px] p-2 text-[12px]" style={{ background: 'var(--color-grey-100)' }}>
      {tokens?.map((t) => (
    ...
    <div className={CARD}>
      ...
      <div className="mt-3 flex flex-col gap-1">
        ...
        <div className="relative flex items-center justify-end">
          <div className="w-[243px] rounded-[4px] p-2 text-[12px] font-medium text-black" style={{ background: 'var(--color-grey-100)' }}>
            Otherwise
          </div>
