...
export function EndNode({ data }: NodeProps) {
  ...
  return (
    <div className="w-[280px] overflow-hidden rounded-[16px] bg-white shadow-[0px_0px_1px_0px_rgba(0,12,32,0.04),0px_2px_6px_0px_rgba(3,17,38,0.11)]">
      ...
      <div className="flex items-center gap-2 border-b p-2.5" style={{ background: 'var(--color-grey-100)', borderColor: '#d2d3d8' }}>
      ...
      {d.ticketTags && d.ticketTags.length > 0 && (
        <div className="flex flex-col gap-1.5 p-3">
          <span className="text-[12px] font-medium" style={{ color: 'var(--color-grey-800)' }}>Ticket Tags:</span>
          {d.ticketTags.map((t) => (
