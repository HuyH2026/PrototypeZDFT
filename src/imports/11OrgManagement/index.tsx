import svgPaths from "./svg-26oegpld1i";
...
function Frame14() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[24px] items-center left-[calc(50%-190px)] top-[433.12px] w-[736px]">
...
function Group2() {
  return (
    <div className="absolute left-[321.32px] size-[327.122px] top-[82px]">
...
function IconWidget() {
  return (
    <div className="absolute flex items-center justify-center left-[284.45px] size-[65.977px] top-[130.22px]">
...
function IconWidget1() {
  return (
    <div className="absolute flex items-center justify-center left-[565.24px] size-[65.579px] top-[269.2px]">
...
function IconWidget2() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[435.72px] p-[17.763px] rounded-[47.369px] shadow-[0px_0px_1.553px_0px_rgba(0,12,32,0.04),3.106px_7.765px_12.425px_0px_rgba(3,17,38,0.11)] size-[94.544px] top-[203.01px]" style={{ backgroundImage: "linear-gradient(135deg, rgb(141, 89, 177) 20%, rgb(64, 108, 196) 125%)" }} data-name="Icon / Widget">
...
function IconWidget3() {
  return (
    <div className="absolute flex items-center justify-center left-[696.66px] size-[42.55px] top-[211.52px]">
...
function IconWidget4() {
  return (
    <div className="absolute flex items-center justify-center left-[419.65px] size-[36.318px] top-[106.58px]">
...
function IconWidget5() {
  return (
    <div className="absolute flex items-center justify-center left-[215.43px] size-[53.509px] top-[289.99px]">
...
function IconWidget6() {
  return (
    <div className="absolute flex items-center justify-center left-[820.52px] size-[34.487px] top-[178.43px]">
...
function IconWidget7() {
  return (
    <div className="absolute flex items-center justify-center left-[119px] size-[36.268px] top-[211.52px]">
...
function IconWidget8() {
  return (
    <div className="absolute flex items-center justify-center left-[569.98px] size-[50.751px] top-[103.74px]">
...
function Group3() {
  return (
    <div className="absolute contents left-[119px] top-[82px]">
      <Group2 />
      <IconWidget />
      <div className="absolute flex items-center justify-center left-[324.16px] size-[37.82px] top-[254.07px]">
...
function Group4() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <Frame14 />
      <Group3 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['SF_Pro_Display:Regular',sans-serif] justify-center leading-[0] left-[40px] not-italic text-[#2f3941] text-[26px] top-[53px] tracking-[0.3536px] whitespace-nowrap">
...
function Frame2() {
  return (
    <div className="absolute h-[837px] left-[54.2px] top-[0.2px] w-[1368px]">
      <Group4 />
      <Fields1 />
    </div>
  );
...
function Nav() {
  return (
    <div className="absolute content-stretch flex flex-col h-[837px] items-center justify-between left-[-0.8px] py-[12px] rounded-tl-[26px] top-[-0.8px]" data-name="🧭 Nav">
...
export default function Component11OrgManagement() {
  return (
    <div className="bg-[#f1efed] relative size-full" data-name="11 org management">
      <TopNavbar />
      <Header />
    </div>
  );
